...
;(function($) {
    ...
    function Slider(opts){
        ...
        this.outer = opts.dom.getElementsByTagName('ul')[0]; //ul
        this.lis = this.outer.getElementsByTagName('li'); //li
        //构造三步奏
        this.init();
        this.bindDOM();
    }
    ...
    Slider.prototype.bindDOM = function(){
        ...
        var moveHandler = function(e){
            ...
            if (self.offsetY > 0) {
                ...
                if (self.offsetY < -50) {
                    $(lis[self.initIndex + 1]).find('.content').show();
                }
            }
        };
        //手指抬起的处理事件
    ...
    $.fn.slider = function() {
        ...
        if (!data) this.data('Slider', new Slider({dom: this[0]}));
        return this;
    }
